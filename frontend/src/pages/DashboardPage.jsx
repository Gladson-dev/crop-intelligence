  ...
  const [systemAlerts, setSystemAlerts] = useState([
    {
      id: 1,
      type: 'warning',
      message: 'Irrigation system needs maintenance',
      time: '2 hours ago',
      icon: <WarningIcon color="warning" />
    },
    {
      id: 2,
      type: 'error',
      message: 'Moisture level low in Field A',
      time: '5 hours ago',
      icon: <ErrorIcon color="error" />
    },
    {
  ...
  const [zones, setZones] = useState([
    ...
    { 
      ...
      soil: {
        ...
        potassium: 'Medium',
        organicMatter: '4.2%',
        texture: '40% sand, 40% silt, 20% clay',
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={4}>
          <Box flex={1}>
            <Typography 
              ...
              gutterBottom
            >
              Welcome, {memoizedUserData?.username ? 
                memoizedUserData.username.charAt(0).toUpperCase() + memoizedUserData.username.slice(1) : 
                'User'}
            </Typography>
          ...
          <Box flex={1} /> {/* This empty box maintains the flex layout */}
          ...
          >
            <Avatar
              ...
              alt={memoizedUserData?.username || 'User'}
              sx={{
                width: 40,
                height: 40,
            ...
            >
              {memoizedUserData?.username 
                ? memoizedUserData.username.charAt(0).toUpperCase() 
                : <PersonIcon />}
            </Avatar>
          </IconButton>
          <Menu
              ...
              <TableBody>
                {irrigationZones.map((zone) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip 
                        label={zone.soil?.type || 'N/A'} 
                        size="small"
                        color={
                          zone.soil?.type === 'loamy' ? 'success' : 
                          zone.soil?.type === 'sandy' ? 'warning' :
                          zone.soil?.type === 'clay' ? 'secondary' : 'default'
                        }
                        variant="outlined"
                      />
                    </TableCell>
                    <TableCell>
                      <Box sx={{ 
                        display: 'flex', 
                        alignItems: 'center',
                        color: zone.soil?.pH < 6 ? 'warning.dark' : 
                              zone.soil?.pH > 7.5 ? 'info.dark' : 'success.dark',
                        fontWeight: 500
                      }}>
                        {zone.soil?.pH || 'N/A'}
                      </Box>
